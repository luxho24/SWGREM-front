...
const Quotation = () => {
  ...
  const handleCheckboxChange = (e) => {
    ...
    setFormData((prevFormData) => ({
      ...prevFormData,
      selectedProblems: checked
        ? [...prevFormData.selectedProblems, value]
        : prevFormData.selectedProblems.filter((problem) => problem !== value),
    }));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    formDataToSend.append(
      "selectedProblems",
      JSON.stringify(formData.selectedProblems)
    );
    formDataToSend.append("otherProblem", formData.otherProblem);
    formDataToSend.append("descriptionProblem", formData.descriptionProblem);
    formDataToSend.append("name", formData.name);
    formDataToSend.append("email", formData.email);
    formDataToSend.append("phone", formData.phone);
    formDataToSend.append("foto", formData.foto); // Agrega la imagen al FormData
    formDataToSend.append("video", formData.video); // Agrega el video al FormData

    try {
        const response = await createQuotation(formDataToSend);
    ...
    <div className="min-h-screen flex flex-col justify-center items-center py-28">
      ...
      >
        ...
        <div className="mb-4">
          ...
          <div className="grid grid-cols-2 gap-4 my-6">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="opcion1" className="mr-4 cursor-pointer">
            ...
            <div className="flex items-center">
              <input
                ...
                className="mr-2 cursor-pointer"
              />
              <label htmlFor="opcion2" className="mr-4 cursor-pointer">
            ...
            <div className="flex items-center">
              <input
                ...
                className="mr-2 cursor-pointer"
              />
              <label htmlFor="opcion3" className="mr-4 cursor-pointer">
                Mi equipo no carga
              </label>
            </div>
            <div className="flex items-center">
              <input
                ...
                className="mr-2 cursor-pointer"
              />
              <label htmlFor="opcion4" className="mr-4 cursor-pointer">
                Mi equipo se mojó
              </label>
            </div>
            <div className="flex items-center">
              <input
                ...
                className="mr-2 cursor-pointer"
              />
              <label htmlFor="opcion5" className="mr-4 cursor-pointer">
            ...
            <div className="flex items-center">
              <input
                ...
                className="mr-2 cursor-pointer"
              />
              <label htmlFor="opcion6" className="mr-4 cursor-pointer">
                Otro
              </label>
            </div>
          </div>
        ...
        <div className="mb-6 py-3 flex items-center">
          ...
          />
          <label htmlFor="privacyPolicies" className="mr-4 cursor-pointer">
            Acepto las{" "}
            <a
